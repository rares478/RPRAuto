                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
                                ...
                                <defs>
                                    ...
                                    <clipPath id="clip0_2_17">
                                        <rect width="28.469" height="28.469" fill="white" transform="translate(0.264648 0.526367)"></rect>
                                    </clipPath>
                                </defs>
                            </svg>
                        </button>
            ...
            <div className="content-container">
                ...
                <div className="card-3d-container">
                    <div className="card-3d">
                        <div><img src="/assets/unu.png" alt="Image 1" /></div>
                        <div><img src="/assets/doi.png" alt="Image 2" /></div>
                        <div><img src="/assets/trei.png" alt="Image 3" /></div>
                ...
                <div className="cards-group">
                    <div className="card">
                        <div className="card-info">
                            <p className="title">Customer Review 1</p>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-info">
                            <p className="title">Customer Review 2</p>
                        </div>
                    </div>
                    <div className="card">
                        <div className="card-info">
                            <p className="title">Customer Review 3</p>
                        </div>
                    </div>
                </div>
            </div>
