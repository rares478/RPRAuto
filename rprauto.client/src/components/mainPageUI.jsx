        ...
        <div className="main-container" content="width=device-width, initial-scale=1.0">
            ...
            <div className="buttons-container">
                ...
                <div className="left-buttons">
                    ...
                    <div className="radio-wrapper">
                        <input
                            ...
                            className="input"
                        />
                        <label className="btn" htmlFor="value-2">
                            MARKET
                        </label>
                    </div>
                    <div className="radio-wrapper">
                ...
                <div className="right-buttons">
                    <div className="radio-wrapper">
                        <input type="radio" id="value-4" name="btn-right" className="input" />
                        <label className="btn" htmlFor="value-4">
                            PROFILE
                        </label>
                    </div>
                    <div className="radio-wrapper">
                        <input
                            ...
                            className="input"
                        />
                        <label className="btn" htmlFor="value-5">
                            RIGHT 2
                        </label>
                    </div>
                    <div className="radio-wrapper">
                        <input type="radio" id="value-6" name="btn-right" className="input" />
                        <label className="btn" htmlFor="value-6">
                            RIGHT 3
                        </label>
                    </div>
                </div>
                                ...
                                <defs>
                                    ...
                                    <clipPath id="clip0_2_17">
                                        <rect
                                            ...
                                            height="28.469"
                                            fill="white"
                                            transform="translate(0.264648 0.526367)"
                                        />
                                    </clipPath>
                                </defs>
                            </svg>
            ...
            <div className="content-container">
                <div className="card-3d-container">
                    <div className="card-3d">
                            ...
                            <div>
                                <img src="doi.png" alt="Image 2" />
                            </div>
                            <div>
                                <img src="trei.png" alt="Image 3" />
                            </div>
                            <div>
                                <img src="patru.png" alt="Image 4" />
                            </div>
                            <div>
